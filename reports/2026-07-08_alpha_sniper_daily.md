...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `RE` | `REUSDT` | binance_usdm,okx_swap,bybit_linear | listed_quiet / 观察 | 12348023.45 | 18309975.17 | -20.98% | -1.77% | -0.0190% | 107054347.94 | -2.49% | 降杠杆 | 合约已上线，暂未出现明显OI/资金费率信号；盘口±50bps bid≈79140.72 ask≈74714.42 spread≈1.57bps，盘口厚度可用; OI收缩，合约资金撤退，价格信号需要现货成交确认 |
| `ARX` | `ARXUSDT` | binance_usdm,okx_swap,bybit_linear | active_perp_market / 可观察 | 2931125.89 | 4956711.37 | +0.30% | -27.82% | -0.0118% | 58260031.43 | -15.34% | 费率变化 | 合约成交活跃，可配合链上出流和价格结构判断；盘口±50bps bid≈19357.65 ask≈25530.51 spread≈5.48bps，合约盘口薄；其他场地 okx_swap 可观察 OI≈744677.89 funding 0.0031%；bybit_linear 可观察 OI≈1280907.59 funding 0.0042%; 资金费率变化明显，观察是否形成拥挤方向 |
| `GRAM` | `GRAMUSDT` | binance_usdm,okx_swap,bybit_linear | listed_quiet / 观察 | 9442212.11 | 37296718.44 | -31.71% | +1.97% | -0.0252% | 26392045.54 | -7.46% | 降杠杆 | 合约已上线，暂未出现明显OI/资金费率信号；盘口±50bps bid≈80439.61 ask≈75907.88 spread≈6.29bps，盘口厚度可用; OI收缩，合约资金撤退，价格信号需要现货成交确认 |
| `NES` | `NES-USDT-SWAP` | okx_swap | active_perp_market / 可观察 | 4028909.95 | 4028909.95 | +201.78% | +85.02% | 0.0050% | 38130962.48 | 20.78% | 多头增量 | Binance USD-M未上；okx_swap 合约成交活跃，可配合链上出流和价格结构判断; OI扩张且价格上涨，重点等现货承接和链上净流确认 |
| `CAP` | `CAPUSDT` | binance_usdm,okx_swap,bybit_linear | listed_quiet / 观察 | 2840765.29 | 5364729.75 | -33.01% | -42.25% | 0.0050% | 20227187.69 | -5.51% | 降杠杆 | 合约已上线，暂未出现明显OI/资金费率信号；盘口±50bps bid≈15832.15 ask≈8394.55 spread≈4.94bps，合约盘口薄; OI收缩，合约资金撤退，价格信号需要现货成交确认 |
| `ESPORTS` | `ESPORTSUSDT` | binance_usdm,bybit_linear | active_perp_market / 可观察 | 6178540.66 | 8955453.62 | -45.77% | -43.96% | 0.0064% | 17404758.23 | -27.78% | 降杠杆 | 合约成交活跃，可配合链上出流和价格结构判断；盘口±50bps bid≈7151.43 ask≈9968.54 spread≈6.38bps，合约盘口薄；其他场地 bybit_linear 可观察 OI≈2776912.96 funding 0.0413%; OI收缩，合约资金撤退，价格信号需要现货成交确认 |
| `VELVET` | `VELVETUSDT` | binance_usdm,bybit_linear | active_perp_market / 可观察 | 6073759.56 | 8378352.49 | -88.22% | -74.66% | -0.0025% | 47087209.63 | -11.42% | 降杠杆 | 合约成交活跃，可配合链上出流和价格结构判断；盘口±50bps bid≈20700.53 ask≈6640.31 spread≈4.80bps，合约盘口薄；其他场地 bybit_linear 可观察 OI≈2304592.93 funding 0.0005%; OI收缩，合约资金撤退，价格信号需要现货成交确认 |
