...
| --- | --- | --- | ---: | ---: | --- | --- | --- |
| `VELVET` | Alpha 放量收跌；卖出/减仓观察 | 持仓减风险；空仓不接，等止跌承接 | +3.21%/-21.93%/-18.10% | 436004.25 | UNKNOWN / PRICE_ONLY | normal | 15m close -18.10%，低点 -21.93%，成交额≈436,004.25 USDT；当前 +5% 卖盘约 23,503.34 USDT，盘口偏薄；盘口结构: 买盘重复数量梯队(144.53 x5) |
| `ARX` | 无价格异动 | 观察 | +0.59%/-0.35%/+0.39% | 21642727.38 | UNKNOWN / PRICE_ONLY | crossed_or_stale | 未触发价格/成交额阈值；盘口结构: 盘口交叉或快照异常，盘口结构不下方向 |
| `CAP` | 无价格异动 | 观察 | +0.37%/-0.38%/-0.02% | 42661.87 | UNKNOWN / PRICE_ONLY | normal | 未触发价格/成交额阈值；当前 +5% 卖盘约 15,689.52 USDT，盘口偏薄；盘口结构: 卖盘重复数量梯队(3937.76 x8)，买盘重复数量梯队(3937.76 x10) |
| `NES` | 无价格异动 | 观察 | +0.56%/-0.52%/-0.47% | 1511704.54 | UNKNOWN / PRICE_ONLY | crossed_or_stale | 未触发价格/成交额阈值；盘口结构: 盘口交叉或快照异常，盘口结构不下方向 |

- Alpha 价格层只给动作提醒和注意力排序，跟随口径仍需要链上成交、首批去向、活动分发和可售性共同确认。

## Holder Concentration

| Symbol | Action | Effective Top10 | Raw Top10 | Infra Top10 | Coverage |
| --- | --- | ---: | ---: | ---: | --- |
| `NES` | 观察；筹码集中度未给出新方向 | 0.0284% (-0.0004%) | 0.0843% (-0.0004%) | 0.0566% | window_or_incremental_reconstruction |
| `CAP` | 观察；筹码集中度未给出新方向 | 9.7851% (+0.0196%) | 16.5530% (+0.1108%) | 6.8655% | window_or_incremental_reconstruction |
| `WDATAIP` | 观察；筹码集中度未给出新方向 | 3.0103% (+0.0005%) | 27.4565% (+0.2587%) | 24.5315% | window_or_incremental_reconstruction |

- Holder 层用于判断筹码集中/分散；有效前十已剔除 CEX、Alpha 托管、LP、桥和 Pancake 基础设施。
