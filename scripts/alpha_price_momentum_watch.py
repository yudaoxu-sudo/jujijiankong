...
def latest_perp_context(symbol: str) -> dict[str, Any]:
    ...
    for row in snapshot.get("rows", []):
        ...
        return {
            ...
            "oi_venue_components": row.get("oi_venue_components", {}),
            ...
            "oi_scope": row.get("oi_scope", ""),
            "total_oi_trend_status": row.get("total_oi_trend_status", ""),
            "total_oi_venue_coverage": row.get("total_oi_venue_coverage", []),
            "total_oi_data_quality": row.get("total_oi_data_quality", ""),
            "total_oi_usd_delta": row.get("total_oi_usd_delta", ""),
            "total_oi_usd_delta_pct": row.get("total_oi_usd_delta_pct", ""),
