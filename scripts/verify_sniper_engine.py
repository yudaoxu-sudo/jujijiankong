...
def main(argv: list[str] | None = None) -> int:
    ...
    required_files = [
        ...
        ROOT / "scripts" / "migrate_alpha_liquidity_seed.py",
        ROOT / "scripts" / "prepare_alpha_liquidity_recovery_enrichment.py",
        ROOT / "scripts" / "finalize_alpha_liquidity_recovery.py",
        ROOT / "scripts" / "apply_alpha_liquidity_recovery.py",
        ROOT / "scripts" / "test_alpha_liquidity_seed_recovery.py",
        ROOT / "scripts" / "test_alpha_holder_recovery_notification_policy.py",
        ROOT / "scripts" / "test_prepare_alpha_liquidity_recovery_enrichment.py",
        ROOT / "scripts" / "test_finalize_alpha_liquidity_recovery.py",
        ROOT / "scripts" / "test_apply_alpha_liquidity_recovery.py",
        ...
        ROOT / "scripts" / "test_manual_research_proposal_policy.py",
        ...
        ROOT / "scripts" / "test_elonkely_exact_anchor_replay.py",
    ...
    try:
        ...
        exact_replay = json.loads(
            (ROOT / "input" / "elonkely_exact_anchor_replay_2026-07-29.json").read_text(
                encoding="utf-8"
            )
        )
        replay_module_path = (
        ...
        elonkely_review_ok = (
            ...
            and exact_replay.get("schema") == "exact_anchor_market_replay.v1"
            ...
            and parti_replay.get("status") == "blocked_incomplete_series"
            ...
            and evaa_replay.get("status") == "complete"
        ...
        elonkely_review_msg = (
            ...
            f"PARTI={parti_replay.get('status')}, EVAA={evaa_replay.get('status')}"
        )
    except Exception as exc:
    ...
    fixture_test_scripts = (
        ...
        ("Alpha liquidity recovery candidate preparation regression tests", "test_finalize_alpha_liquidity_recovery.py"),
        ("Alpha liquidity recovery candidate apply regression tests", "test_apply_alpha_liquidity_recovery.py"),
        ("KII prelaunch evidence and generic-scope regression", "test_kii_prelaunch_config.py"),
        ("manual research proposal suppression regression", "test_manual_research_proposal_policy.py"),
...
"""
    ...
    compile_cmd = [
        ...
        str(ROOT / "scripts" / "migrate_alpha_liquidity_seed.py"),
        str(ROOT / "scripts" / "prepare_alpha_liquidity_recovery_enrichment.py"),
        str(ROOT / "scripts" / "finalize_alpha_liquidity_recovery.py"),
        str(ROOT / "scripts" / "apply_alpha_liquidity_recovery.py"),
        str(ROOT / "scripts" / "test_alpha_liquidity_seed_recovery.py"),
        str(ROOT / "scripts" / "test_alpha_holder_recovery_notification_policy.py"),
        str(ROOT / "scripts" / "test_prepare_alpha_liquidity_recovery_enrichment.py"),
        str(ROOT / "scripts" / "test_finalize_alpha_liquidity_recovery.py"),
        str(ROOT / "scripts" / "test_apply_alpha_liquidity_recovery.py"),
        ...
        str(ROOT / "scripts" / "test_manual_research_proposal_policy.py"),
